...
import io.quarkus.azure.functions.runtime.AzureFunctionsRecorder;
...
public class AzureFunctionsProcessor {
    ...
    private static final DotName[] PARAMETER_ANNOTATIONS = {
            AzureFunctionsDotNames.BLOB_TRIGGER,
            AzureFunctionsDotNames.COSMOS_DB_TRIGGER,
            AzureFunctionsDotNames.EVENT_GRID_TRIGGER,
            AzureFunctionsDotNames.EVENT_HUB_TRIGGER,
            AzureFunctionsDotNames.HTTP_TRIGGER,
            AzureFunctionsDotNames.QUEUE_TRIGGER,
            AzureFunctionsDotNames.SERVICE_BUS_QUEUE_TRIGGER,
            AzureFunctionsDotNames.SERVICE_BUS_TOPIC_TRIGGER,
            AzureFunctionsDotNames.TIMER_TRIGGER
    };
    ...
    public void registerArc(CombinedIndexBuildItem combined,
        ...
        for (DotName ann : PARAMETER_ANNOTATIONS) {
    ...
    @Record(STATIC_INIT)
    @BuildStep
    void setupInjection(AzureFunctionsRecorder recorder,
            BeanContainerBuildItem beanContainerBuildItem) {
        recorder.setupIntegration(beanContainerBuildItem.getValue());
    }
